                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h4>Editar Ficha
                                    <a href="ficha.php" class="btn btn-danger btn-sm float-end">Regresar</a>
                                </h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <form action="codeficha.php" method="POST">
                                            ...
                                            <div class="row mt-1">
                                                ...
                                                <div class="col-12 mt-3">
                                                    <input type="number" class="form-control" name="telefono" id="telefono" value="<?= $registro['telefono']; ?>" disabled>
                                                </div>


                                                <div class="col-12 mt-3">
                                                    <input type="mail" class="form-control" name="email" id="email" value="<?= $registro['email']; ?>" disabled>
                                                </div>


                                                <div class="col-12 mt-3">
                                                    <input type="text" class="form-control" name="fotoperfil" id="fotoperfil" value="<?= $registro['fotoperfil']; ?>" disabled>
                                                </div>


                                                <div class="col-12 mt-3">
                                                    <input type="date" class="form-control" name="fechanacimiento" id="fechanacimiento" value="<?= $registro['fechanacimiento']; ?>" disabled>
                                                </div>
